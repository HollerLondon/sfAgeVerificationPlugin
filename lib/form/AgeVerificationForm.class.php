...
class AgeVerificationForm extends BaseForm
{
  ...
  public function getCountryCodes()
  {
    ...
    {
      // We can specify all countries in the config, but what if we only want a subset
      if ($allowedCountries = sfConfig::get('app_sf_age_verification_allowed_countries', false))
      {
        $this->country_codes = $allowedCountries;
      }
      else $this->country_codes = array_keys($this->getCountriesConfig());
    }
